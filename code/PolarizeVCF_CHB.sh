##qsub -cwd -V -N recodeVCF -l highp,time=2:00:00,h_data=1G -t 1-22:1 -M eplau -m ea recode_EPOAllele_GenoState.sh 


in_dir='/u/scratch/j/jessegar/1000GenomesLD/1000GVCF_subset/CHB'
out_dir='/u/home/j/jessegar/project-klohmuel/LD1000GenomePolarizedVCF/CHB'

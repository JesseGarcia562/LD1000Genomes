...
require(data.table)
setwd("/u/home/j/jessegar/project-klohmuel/LD1000GenomePolarizedVCF/CEU2/VariantSplit/Doubletons/LDStats/BinnedLD")
...
write.csv(BinnedLDTableYRIAll, file="BinnedLDTableCEUDoubletons.csv", quote=FALSE)

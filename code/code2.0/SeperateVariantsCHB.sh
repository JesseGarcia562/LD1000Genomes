...
Population='CHB'
outDir='/u/home/j/jessegar/project-klohmuel/LD1000GenomePolarizedVCF/'${Population}'2/VariantSplit'
mkdir ${outDir}
...
inVCF='/u/home/j/jessegar/project-klohmuel/LD1000GenomePolarizedVCF/'${Population}'2/chr'${i}'_10'${Population}'_rmHomozygous_Annotated.vcf.hg19_multianno.vcf'
outDir='/u/home/j/jessegar/project-klohmuel/LD1000GenomePolarizedVCF/'${Population}'2/VariantSplit'
